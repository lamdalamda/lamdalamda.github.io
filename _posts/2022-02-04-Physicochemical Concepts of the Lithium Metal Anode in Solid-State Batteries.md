...
锂在阳极中通过空位传输，在固体电解质中通过空位或者interstitial等机制传输。由于固体电解质中传输特别快，所以可以忽略固体电解质（或者说离子导体）中点缺陷的弛豫（因为锂可以很快地传输到负极）。而在锂金属中，由于脱锂过程是在锂金属表面，生成的空位逐渐再向体中扩散，所以会形成一个空位浓度的梯度

# 第六章

锂金属阳极充放电

至少对于充电过程（锂生长）来说，对于电流和电解质的孔隙度有着比较严格的要求，超过临界电流或者低于足够的孔隙度则会很容易发生短路（锂刺穿电解质）
